...
INSERT INTO checklist_items (
  ...
  'DOC', 1, 'NF C 15-100 (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'DOC', 2, 'UTE C 15-712 (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'DOC', 3, 'DTU 40.35 (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
...
INSERT INTO checklist_items (
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'DOC', 5, 'Bonnes pratiques constatées (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'DOC', 6, 'Mauvaises pratiques constatées (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 7, 'Autocontrôle présent (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 8, 'PV réception lot PV présent (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 9, 'CR visite chantier présent (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 10, 'Tranchées respectent CDC GIRASOLE (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 11, 'Documents GIRASOLE signalent écarts (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 12, 'Mise à la terre conforme (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 13, 'Schéma électrique présent (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'ELEC', 14, 'Étiquetage câbles conforme (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TABLEAUX', 15, 'Coffret AC conforme (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TABLEAUX', 16, 'Coffret DC conforme (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TABLEAUX', 17, 'Protection foudre présente (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TABLEAUX', 18, 'Disjoncteurs dimensionnés (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'CABLAGE', 19, 'Section câbles DC conforme (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'CABLAGE', 20, 'Section câbles AC conforme (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'CABLAGE', 21, 'Connecteurs MC4 serrés (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'CABLAGE', 22, 'Passage câbles protégé (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'MODULES', 23, 'État visuel modules (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'MODULES', 24, 'Fixations modules conformes (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'MODULES', 25, 'Orientation optimale (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'MODULES', 26, 'Absence d''ombrages (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'STRUCTURES', 27, 'Fondations stables (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'STRUCTURES', 28, 'Structures métalliques conformes (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'STRUCTURES', 29, 'Boulonnerie serrée (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'STRUCTURES', 30, 'Absence de corrosion (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 31, 'DTU 40.35 respecté (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 32, 'Étanchéité toiture conforme (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 33, 'Pénétrations étanches (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 34, 'Écran sous-toiture présent (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 35, 'Ventilation toiture adéquate (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 36, 'Liteaux/chevrons conformes (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 37, 'Crochets inox conformes (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 38, 'Respect poids admissible toiture (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 39, 'Cheminements sécurisés (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 40, 'Dispositifs antichute présents (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 41, 'Jonctions tuiles/modules étanches (O/N)', 'NON_VERIFIE'
);
INSERT INTO checklist_items (
  ordre_mission_id, categorie, item_numero, item_texte,
  statut
  ...
  (SELECT id FROM ordres_mission WHERE centrale_id = (SELECT id FROM centrales WHERE nom = 'SCI KILJOR' LIMIT 1) LIMIT 1),
  'TOITURE', 42, 'Respect DTU série 40 (O/N)', 'NON_VERIFIE'
);
