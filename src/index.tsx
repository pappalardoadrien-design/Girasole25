...
/*  
// Route '/' désactivée - remplacée par serveStatic public/index.html
*/
...
/* FRONTEND ROUTE COMMENTÉE - contient HTML + JS complexe
...
// Route / simple - redirection vers outils
app.get('/', (c) => {
  return c.redirect('/test-api')
})
